...
public class RockCollision : MonoBehaviour
{
    ...
    public void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (!PauseManager.isPaused && other.CompareTag("Player") && !isShielded)
        {
            if (isShielded)
            {
...
<<<<<<< Updated upstream:Flow Runner/Assets/Scripts/RockKill.cs
=======
...
>>>>>>> Stashed changes:Flow Runner/Assets/Scripts/PlayerScripts/RockKill.cs
    }
}
